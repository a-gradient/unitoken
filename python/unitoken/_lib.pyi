...
class BpeEncoderBase:
    def __new__(cls, /, spec: str, char_level: str, vocabs: dict[Sequence[int], int] | None, merges: Sequence[tuple[Sequence[int], Sequence[int]]] | None, vocab_filename: str | PathLike | None, merges_filename: str | PathLike | None) -> BpeEncoderBase: ...
...
@final
class PreTokenizer:
    def __new__(cls, /, special_tokens: Sequence[str], eot_token: str | None) -> PreTokenizer: ...
    def find_chunk_boundaries(self, /, path: str | PathLike, desired_num_chunks: int) -> list[tuple[int, int]]: ...
    def get_words_from_file(self, /, path: str | PathLike, desired_num_chunks: int) -> dict[str, int]: ...
