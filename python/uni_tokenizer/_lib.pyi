...
@final
class BpeModelBase:
    def encoder(self, /, pat_str: str | None = None, unicode_bigrams: Sequence[str] | None = None, unicode_bigram_mixed_boundary: str = "keep") -> BpeEncoderBase: ...
