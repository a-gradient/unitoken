...
class BigramCounter:
    ...
    def select(self, /, top_k: int, min_freq: int) -> UnicodeBigramSelection: ...
    def selected(self, /, top_k: int, min_freq: int) -> list[str]: ...

@final
class BpeEncoderBase:
    def __new__(cls, /, format: str, unit: str, vocab: dict[Sequence[int], int] | None, merges: Sequence[tuple[Sequence[int], Sequence[int]]] | None, vocab_file: str | PathLike | None, merges_file: str | PathLike | None, special_tokens: Sequence[str] | None, pat_str: str | None = None, unicode_bigrams: Sequence[str] | None = None, unicode_bigram_mixed_boundary: str = "keep", split_on_vocab_bigrams: bool = True) -> BpeEncoderBase: ...
...
@final
class BpeModelBase:
    def encoder(self, /, pat_str: str | None = None, unicode_bigrams: Sequence[str] | None = None, unicode_bigram_mixed_boundary: str = "keep", split_on_vocab_bigrams: bool = True) -> BpeEncoderBase: ...
...
class BpeTrainer_Character_CharIdx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None, parallel_merge_min_occurs_in: int | None = None, hot_pair_window_size: int | None = None, bigram_cutoff_freq: int | None = None) -> BpeTrainer_Character_CharIdx: ...
    ...
    def train_until_with_bbpe_fallback(self, /, vocab_size: int, *, primary_vocab_ratio: float = 0.9) -> int: ...
...
class BpeTrainer_u8_Idx(BpeTrainerBase):
    def __new__(cls, /, special_tokens: Sequence[str], initial_alphabet: str | None = None, tie_break: str | None = None, parallel_merge_min_occurs_in: int | None = None, hot_pair_window_size: int | None = None, bigram_cutoff_freq: int | None = None) -> BpeTrainer_u8_Idx: ...
    def add_word_counter(self, /, counter: WordCounter) -> None: ...
    def add_words(self, /, words: Sequence[tuple[str, int]]) -> None: ...
    def get_vocab(self, /) -> Vocabulary: ...
    def init_training(self, /) -> None: ...
...
class PreTokenizer:
    ...
    def select_unicode_bigrams_from_file(self, /, path: str | PathLike, *, chunk_size: int = 1048576, boundary: str = "auto", top_k: int = 100000, min_freq: int = 16) -> UnicodeBigramSelection: ...
    def word_counter(self, /) -> WordCounter: ...

@final
class UnicodeBigramSelection:
    @property
    def bigrams(self) -> list[str]: ...
    @property
    def cutoff_freq(self) -> int | None: ...
    @property
    def max_excluded_freq(self) -> int | None: ...
